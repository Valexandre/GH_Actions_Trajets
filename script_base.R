...
GraphDOuVientTravailler<-DOuVientTravailler%>%top_n(.,n=3,wt = Part)%>%
  left_join(Varmod_MOBPRO_2018%>%filter(COD_VAR=="COMMUNE")%>%select(COD_MOD,LIB_MOD),by=c("CODGEORES"= "COD_MOD"))%>%
