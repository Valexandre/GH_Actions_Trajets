...
ComSelec<-sample(JusteCommunesImportantes$INSEE_COM[substr(JusteCommunesImportantes$INSEE_COM,1,2)%in%c(75,77,78,91:95) & JusteCommunesImportantes$INSEE_COM!="75056"],1)
